...
util.simulate_dataset_1d_via_profile_list_from(
    profile_list=[gaussian, exponential], dataset_path=dataset_path
)
...
util.simulate_dataset_1d_via_profile_list_from(
    profile_list=[gaussian_0, gaussian_1, exponential], dataset_path=dataset_path
)
...
util.simulate_dataset_1d_via_profile_list_from(
    profile_list=[gaussian_0, gaussian_1, gaussian_2], dataset_path=dataset_path
)
...
util.simulate_dataset_1d_via_profile_list_from(
    profile_list=[gaussian, gaussian_feature], dataset_path=dataset_path
)
