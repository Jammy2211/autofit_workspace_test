...
gaussian_2.normalization = af.UniformPrior(lower_limit=0.0, upper_limit=1e2)
...
"""
analysis_factor_0 = g.AnalysisFactor(prior_model=gaussian_0, analysis=analysis_0)
analysis_factor_1 = g.AnalysisFactor(prior_model=gaussian_1, analysis=analysis_1)
analysis_factor_2 = g.AnalysisFactor(prior_model=gaussian_2, analysis=analysis_2)
...
search = af.DynestyStatic(
    path_prefix=path.join("graphical"), name="simultaneous_fit", sample="rwalk"
)
