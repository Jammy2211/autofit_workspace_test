...
__Model__
"""
centre_shared_prior = af.GaussianPrior(mean=50.0, sigma=30.0, lower_limit=40.0, upper_limit=60.0)
...
for model_index in range(len(data_list)):
    ...
    gaussian.normalization = af.GaussianPrior(mean=3.0, sigma=5.0, lower_limit=1.0, upper_limit=10.0)
    gaussian.sigma = af.GaussianPrior(mean=10.0, sigma=10.0, lower_limit=5.0, upper_limit=15.0)
